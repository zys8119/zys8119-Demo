    ...
    return kity.createClass('InputComponent', {
        ...
        focus: function () {
            ...
            if (!this.kfEditor.requestService('syntax.has.cursor.info')) {
                rootInfo = this.kfEditor.requestService(
        ...
        updateInput: function () {
            var latexInfo = this.kfEditor.requestService(
        ...
        insertStr: function (str) {
            ...
            // 拼接latex字符串
            originString =
                originString.substring(0, latexInfo.startOffset) +
                ' ' +
                str +
                ' ' +
                originString.substring(latexInfo.endOffset);
