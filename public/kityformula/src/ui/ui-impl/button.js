        ...
        Button = kity.createClass('Button', {
            ...
            showMount: function () {
                ...
                if (this.fixOffset) {
                    ...
                    this.mountElement.setOffset(
                        elementRect.left + LIST_OFFSET,
                        elementRect.bottom
                    );
                }
                ...
                if (mountEleBox.right > containerBox.right) {
                    ...
                    // 对齐到按钮的右边界
                    this.mountPoint.style.left =
                        currentBox.right - mountEleBox.right - 1 + 'px';
                }
            ...
            createIcon: function () {
                ...
                if (typeof this.options.icon === 'string') {
                    ...
                    iconNode.style.background = getBackgroundStyle(
                        this.options.icon
                    );
                }
