    ...
    var kity = require('kity'),
        ...
        Box = kity.createClass('Box', {
            ...
            updateSize: function () {
                ...
                if (this.options.type === BOX_TYPE.DETACHED) {
                    ...
                    this.element.style.height =
                        curBox.height -
                        (curBox.bottom - containerBox.bottom + diff) +
                        'px';
                } else {
                    ...
                    panel.style.height =
                        containerBox.bottom - panelRect.top - diff + 'px';
                }
            },
            ...
            createGroup: function () {
                var doc = this.doc,
                    ...
                    groupTitle = null,
                    itemType =
                        BOX_TYPE.DETACHED === this.options.type
                            ? ITEM_TYPE.BIG
                            : ITEM_TYPE.SMALL,
                    itemContainer = null;
                ...
                kity.Utils.each(this.options.group, function (group, i) {
                    ...
                    kity.Utils.each(group.items, function (item) {
                        ...
                        kity.Utils.each(
                            createItems(doc, item.content, itemType),
                            function (boxItem) {
        ...
        BoxItem = kity.createClass('BoxItem', {
            ...
            createSmallContent: function () {
                ...
                tmpNode.style.backgroundPosition =
                    -tmpContent.pos.x + 'px ' + -tmpContent.pos.y + 'px';
                // 附加属性到项的根节点上
