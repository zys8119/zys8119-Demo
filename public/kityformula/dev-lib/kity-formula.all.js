...
(function () {
        ...
        function stackBlurCanvasRGBA(id, top_x, top_y, width, height, radius) {
            ...
            for (y = 0; y < height; y++) {
                ...
                for (i = 1; i < radiusPlus1; i++) {
                    ...
                    r_sum +=
                        (stack.r = pr = pixels[p]) * (rbs = radiusPlus1 - i);
            ...
            for (x = 0; x < width; x++) {
                ...
                for (i = 1; i <= radius; i++) {
                    yi = (yp + x) << 2;
                    r_sum +=
                        (stack.r = pr = pixels[yi]) * (rbs = radiusPlus1 - i);
        ...
        (function () {
            ...
            function build() {
                ...
                svg.Property.prototype.toPixels = function (
                    ...
                    if (s.match(/pt$/))
                        return (
                            this.numValue() * this.getDPI(viewPort) * (1 / 72)
                        );
                    ...
                    if (s.match(/%$/))
                        return (
                            this.numValue() * svg.ViewPort.ComputeSize(viewPort)
                        );
                    var n = this.numValue();
                    ...
                    if (node != null && node.nodeType == 1) {
                        for (var i = 0; i < node.childNodes.length; i++) {
                            ...
                            if (
                                ...
                                var text =
                                    childNode.nodeValue || childNode.text || '';
                        ...
                        if (this.attribute('id').hasValue()) {
                            var styles =
                                svg.Styles['#' + this.attribute('id').value];
                            if (styles != null) {
                                for (var name in styles) {
                                    this.styles[name] = styles[name];
                                }
                        ...
                        if (this.attribute('id').hasValue()) {
                            if (
                                svg.Definitions[this.attribute('id').value] ==
                                null
                            ) {
                                svg.Definitions[this.attribute('id').value] =
                                    this;
                ...
                svg.Element.path = function (node) {
                    ...
                    this.PathParser = new (function (d) {
                        ...
                        this.isCommandOrEnd = function () {
                            ...
                            return (
                                this.tokens[this.i + 1].match(/^[A-Za-z]$/) !=
                                null
                            );
                        };
                ...
                svg.Element.AnimateBase = function (node) {
                    ...
                    this.progress = function () {
                        ...
                        if (this.values.hasValue()) {
                            var p =
                                ret.progress * (this.values.value.length - 1);
                            var lb = Math.floor(p),
                                ub = Math.ceil(p);
                ...
                svg.Element.text = function (node) {
                    ...
                    this.getAnchorDelta = function (ctx, parent, startI) {
                        ...
                        if (textAnchor != 'start') {
                            ...
                            return (
                                -1 * (textAnchor == 'end' ? width : width / 2)
                            );
                        }
                        return 0;
                    };
    ...
    define('char/char', ['kity', 'signgroup', 'def/gtype'], function (
        require,
        exports,
        module
    ) {
    ...
    define('expression/compound-exp/binary-exp/subscript', [
        'kity',
    ...
    define('expression/compound-exp/binary-exp/superscript', [
        'kity',
        'expression/compound-exp/script',
        'operator/script',
        'expression/compound'
    ...
    define('expression/compound-exp/binary', [
        'kity',
        'expression/compound',
        'def/gtype',
    ...
    define('expression/compound-exp/brackets', [
        'kity',
        'operator/brackets',
        'char/text',
        'font/manager',
    ...
    define('expression/compound-exp/combination', [
        'kity',
        'sysconf',
        'font/map/kf-ams-main',
        'font/map/kf-ams-cal',
    ...
    define('expression/compound-exp/fraction', [
        'kity',
        'operator/fraction',
        'sysconf',
        'operator/operator',
    ...
    define('expression/compound-exp/func', [
        'kity',
        'sysconf',
        'font/map/kf-ams-main',
        'font/map/kf-ams-cal',
    ...
    define('expression/compound-exp/integration', [
        'kity',
    ...
    define('expression/compound-exp/radical', [
        'kity',
        'operator/radical',
        'operator/operator',
        'expression/compound-exp/binary',
    ...
    define('expression/compound-exp/script', [
        'kity',
        'operator/script',
        'operator/common/script-controller',
        'operator/operator',
    ...
    define('expression/compound-exp/summation', [
        'kity',
        'operator/summation',
        'operator/common/script-controller',
        'operator/operator',
    ...
    define('operator/common/script-controller', [
        'kity',
        'expression/empty',
        'sysconf',
        'expression/expression'
        ...
        return kity.createClass('ScriptController', {
            ...
            applySideSub: function (target, sub) {
                ...
                var targetRectBox = target.getRenderBox(this.observer),
                    ...
                    subPosition =
                        (subRectBox.height + subOffset.top + subOffset.bottom) /
                        2,
    ...
    define('operator/operator', ['kity', 'def/gtype', 'signgroup'], function (
        require,
        exports,
        modules
    ) {
    ...
    define('signgroup', ['kity', 'def/gtype'], function (
        require,
        exports,
        module
    ) {
