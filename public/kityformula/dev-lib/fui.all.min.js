...
!(function () {
    ...
    var _p = {
        r: function (a) {
            ...
            if (((_p[a].inited = !0), (_p[a].value = c), void 0 !== c))
                return c;
            for (var d in b.exports)
                if (b.exports.hasOwnProperty(d))
                    return (
                        (_p[a].inited = !0),
                        (_p[a].value = b.exports),
                        b.exports
                    );
        }
    };
    (_p[0] = {
        ...
        (_p[2] = {
            value: function () {
                var a = _p.r(11);
                a.___register({ TablePicker: _p.r(17) });
            }
        }),
        (_p[3] = {
            value: function () {
            ...
            value: function (require, exports) {
                ...
                function inherit(constructor, BaseClass, classname) {
                    var KityClass = eval(
                        '(function ' +
                            classname +
                            '( __inherit__flag ) {if( __inherit__flag != KITY_INHERIT_FLAG ) {KityClass.__KityConstructor.apply(this, arguments);}this.__KityClassName = KityClass.__KityClassName;})||0'
                    );
                    (KityClass.__KityConstructor = constructor),
                        (KityClass.prototype = new BaseClass(
                            KITY_INHERIT_FLAG
                        ));
                    ...
                    return (
                        (KityClass.prototype.constructor = KityClass), KityClass
                    );
                }
                function mixin(a, b) {
                    ...
                    var c,
                        ...
                        f = b.length;
                    for (
                        a.__KityMixins = { constructor: [] }, c = 0;
                        f > c;
                        c++
                    ) {
                        d = b[c].prototype;
                        for (e in d)
                            !1 !== d.hasOwnProperty(e) &&
                                ...
                                ('constructor' === e
                                    ...
                                    : (a.prototype[e] = a.__KityMixins[e] =
                                          d[e]));
                    }
                    return a;
                }
                ...
                (Function.prototype.bind =
                    ...
                    (Class.prototype.base = function (a) {
                        var b = arguments.callee.caller,
                            c =
                                b.__KityMethodClass.__KityBaseClass.prototype[
                                    a
                                ];
                        return c.apply(
                            this,
                    ...
                    (Class.prototype.pipe = function (a) {
                        return (
                            'function' == typeof a && a.call(this, this), this
                        );
                    }),
                ...
                (Class.prototype._accessProperty = function () {
                    return (
                        this._propertyRawData || (this._propertyRawData = {})
                    );
                }),
                    (exports.createClass = function (a, b) {
                        ...
                        return (
                            ...
                            (d.__KityMethodName = c.__KityMethodName =
                                'constructor'),
        ...
        (_p[6] = {
            value: function () {
                ...
                return {
                    ...
                    getCssRules: function (b, c) {
                        var d = {},
                            e = {},
                            f = null;
                        if (a.isArray(b)) {
                            for (var g = 0, h = b.length; h > g; g++)
                                if (((f = b[g]), 'string' == typeof f))
                                    e[f] = f;
                                else
                                    for (var i in f)
                    ...
                    getBound: function (b) {
                        var c = 0,
                            d = 0;
                        return 'body' === b.tagName.toLowerCase()
                            ? ((d = a(this.getView(b))),
                              (c = d.width()),
                              (d = d.height()),
                              {
        ...
        (_p[8] = {
            value: function () {
                function a(a) {
                    (this.__options = b.extend({}, d, a)),
                        (this.__started = !1),
                        (this.__point = { x: 0, y: 0 }),
                        (this.__location = { x: 0, y: 0 }),
                        (this.__range = {
                            top: 0,
                            left: 0,
                            bottom: 0,
                ...
                return (
                    b.extend(a.prototype, {
                        bind: function (a) {
                            if (
                                (a && (this.__options.target = a),
                                !this.__options.target)
                            )
                        ...
                        __initEvent: function () {
                            var a = (this.__target, this.__handler),
                                d = this;
                                ...
                                b(a.ownerDocument)
                                    .on('mousemove', function (a) {
                                        if (d.__started) {
                                            var b = a.clientX,
                                                c = a.clientY;
                                            d.__allowAxisX && d.__xMove(b),
                                                d.__allowAxisY && d.__yMove(c);
                                        }
                                    })
                                    .on('mouseup', function () {
                                        d.__started = !1;
                        ...
                        __xMove: function (a) {
                            ...
                            (b = this.__location.x + b),
                                b < this.__range.left
                                    ? (b = this.__range.left)
                                    : b > this.__range.right &&
                                      (b = this.__range.right),
                                (this.__target.style.left = b + 'px');
                        },
                        __yMove: function (a) {
                            var b = a - this.__point.y;
                            (b = this.__location.y + b),
                                b < this.__range.top
                                    ? (b = this.__range.top)
                                    : b > this.__range.bottom &&
                                      (b = this.__range.bottom),
                                (this.__target.style.top = b + 'px');
                        },
                        __initEnv: function () {
                        ...
                        __initOptions: function () {
                            this.__options.axis.toLowerCase();
                            this.__handler || (this.__handler = this.__target),
                                this.__rangeNode ||
                                    (this.__rangeNode =
                                        this.__options.target.ownerDocument.body),
                                (this.__allowAxisX =
                                    'y' !== this.__options.axis),
                                (this.__allowAxisY =
                                    'x' !== this.__options.axis);
                        },
                        __getRange: function () {
                            var a = this.__rangeNode,
                                d = c.getRect(this.__target);
                            return (
                                'body' === a.tagName.toLowerCase()
                                    ? ((a = b(this.__rangeNode.ownerDocument)),
                                      (a = {
                                          top: 0,
                                          left: 0,
                                          bottom: a.height(),
            ...
            value: function () {
                function a(d) {
                    ...
                    return 1 === arguments.length
                        ? b(d)
                        : (c.each([].slice.call(arguments, 1), function (b, h) {
                              for (var i in h)
                                  (g = h[i]),
                                      h.hasOwnProperty(i) &&
                                          ((e = c.isPlainObject(g)),
                ...
                function b(d) {
                    var e = null;
                    return c.isPlainObject(d)
                        ? a({}, d)
                        : c.isArray(d)
                        ? ((e = []),
                          c.each(d, function (a, d) {
                              e.push(
                                  c.isPlainObject(d) || c.isArray(d) ? b(d) : d
                              );
                          }),
                          e)
                        : d;
            ...
            value: function () {
                ...
                return _p.r(13).createClass('TPicker', {
                    ...
                    __select: function (a, b) {
                        this.trigger('pickerselect', { row: a, col: b });
                    },
                    __update: function (a, c) {
                        for (
                            var d = null,
                                e = this.__options.row,
                                f = this.__options.col,
                                g = b.classPrefix + 'table-picker-hoverin',
                                h = 0;
                            e > h;
                            h++
                        ) {
                        ...
                        this.trigger('pickerhover', { row: a, col: c });
                    },
                    __createBackplane: function () {
                        for (
                            var c = [], d = null, e = 0, f = this.__options.row;
                            f > e;
                            e++
                        ) {
                            d = [];
                            for (var g = 0, h = this.__options.col; h > g; g++)
                                d.push(
                                    '<td data-index="' + e + ',' + g + '"></td>'
                                );
                            c.push('<tr>' + d.join('') + '</tr>');
                        }
                        return (
                            ...
                            c.addClass(b.classPrefix + 't-picker-table'),
                            c[0]
                        );
                    }
                });
        ...
        (_p[17] = {
            value: function () {
                ...
                return _p.r(13).createClass('TablePicker', {
                    base: _p.r(57),
                    constructor: function (b) {
                        var c = { button: null, row: 10, col: 10 };
                        (b = a.extend({}, c, b)), this.callBase(b);
                    },
                    open: function () {
                    ...
                    __render: function () {
                        this.callBase(),
                            (this.__pickerWidget = new e(this.__options)),
                            (this.__labelWidget = new d({
                                text: '\u63d2\u5165\u8868\u683c'
                            })),
                            (this.__buttonWidget = new f(
                                this.__options.button
                            )),
                            (this.__panelWidget = new g({
                                className: b.classPrefix + 'table-picker-panel',
                                column: !0,
                                resize: 'none'
                            })),
                            (this.__maskWidget = new h()),
                            this.__panelWidget.appendWidget(this.__labelWidget),
                            this.__panelWidget.appendWidget(
                                this.__pickerWidget
                            ),
                    ...
                    __initEvent: function () {
                        var a = this;
                        this.callBase(),
                            this.__buttonWidget.on('btnclick', function () {
                                a.open();
                            }),
                            ...
                            this.__pickerWidget
                                .on('pickerhover', function (b, c) {
                                    var d = c.row + 1,
                                        e = c.col + 1;
                                    a.__labelWidget.setText(
                                        d + 'x' + e + ' \u8868\u683c'
                                    );
                                })
                ...
                return _p.r(13).createClass('ButtonMenu', {
                    ...
                    open: function () {
                        (this.__openState = !0),
                            ...
                            this.addClass(b.classPrefix + 'button-active');
                    },
                    close: function () {
                        (this.__openState = !1),
                            this.__maskWidget.hide(),
                            this.__menuWidget.hide(),
                            this.removeClass(b.classPrefix + 'button-active');
                    },
                    isOpen: function () {
                    ...
                    __render: function () {
                        this.callBase(),
                            this.__initButtons(),
                            (this.__menuWidget = new e(this.__options.menu)),
                            (this.__maskWidget = new f(this.__options.mask)),
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__maskWidget = null),
                            (this.__openState = !1),
                            -1 !== this.__options.selected &&
                                (this.__options.menu.selected =
                    ...
                    __initButtons: function () {
                        ...
                        this.__options.layout === g.TOP ||
                        this.__options.layout === g.LEFT
                            ? ((f = new d(this.__options.buttons[h])),
                              f.appendTo(e))
                            : (h = -1),
                            a.each(this.__options.buttons, function (a, b) {
                                if (h !== a) {
                                    var g = new d(b);
                            ...
                            c[c.length - 1].addClass(
                                b.classPrefix + 'open-btn'
                            ),
                            (this.__buttonWidgets = c);
                    },
                    __initEvent: function () {
                        var b =
                        ...
                        this.callBase(),
                            ...
                            this.on('btnclick', function (b) {
                                ...
                                c > -1 &&
                                    c < this.__buttonWidgets.length - 1 &&
            ...
            value: function () {
                ...
                return _p.r(13).createClass('InputMenu', {
                    ...
                    constructor: function (a) {
                        var c = f.getMarker();
                        this.callBase(c);
                        var d = { input: null, menu: null, mask: null };
                        this.__extendOptions(d, a),
                    ...
                    __render: function () {
                        return this.__rendered
                            ? this
                            : ((this.__inputWidget = new c(
                                  this.__options.input
                              )),
                              (this.__menuWidget = new d(this.__options.menu)),
                              (this.__maskWidget = new e(this.__options.mask)),
                              this.callBase(),
                              this.__inputWidget.appendTo(this.__element),
                              this.__menuWidget.positionTo(this.__inputWidget),
                              void this.__initInputMenuEvent());
                    },
                    open: function () {
                    ...
                    __initInputMenuEvent: function () {
                        ...
                        this.on('buttonclick', function () {
                            this.__menuState ||
                                (this.__appendMenu(), (this.__menuState = !0)),
                    ...
                    __update: function () {
                        ...
                        b &&
                            (a.each(d, function (a, b) {
                                return 0 === b.toLowerCase().indexOf(c)
                                    ? ((e = b), !1)
                                    : void 0;
                            }),
                            e &&
                                (this.__inputWidget.setValue(e),
                                this.__inputWidget.selectRange(b.length)));
                    },
                    ...
                    __inputComplete: function () {
                        ...
                        a.each(b, function (a, b) {
                            ...
                            this.trigger('select', { index: c, value: d }),
                            (e && e.value === d) ||
                                this.trigger('change', {
                                    from: e || { index: -1, value: null },
                                    to: { index: c, value: d }
                                });
                    },
                ...
                return _p.r(13).createClass('Buttonset', {
                    ...
                    getValue: function () {
                        return this.__currentIndex > -1
                            ? this.__widgets[this.__currentIndex].getValue()
                            : null;
                    },
                    ...
                    select: function (b) {
                        return this.__options.disabled
                            ? this
                            : (b instanceof c &&
                                  (b = a.inArray(b, this.__widgets)),
                              0 > b
                                  ? this
                                  : ((b = this.__widgets[b]),
                                    this.__pressButton(b),
                                    this));
                    },
                    ...
                    insertWidget: function (a, b) {
                        ...
                        return null === c
                            ? c
                            : (a <= this.__currentIndex &&
                                  this.__currentIndex++,
                              a <= this.__prevIndex && this.__prevIndex++,
                              c);
                    },
                    removeWidget: function (a) {
                        var b = a;
                        return (
                            'number' != typeof b && (b = this.indexOf(a)),
                            (a = this.callBase(a)),
                            b === this.__currentIndex
                                ? (this.__currentIndex = -1)
                                : b < this.__currentIndex &&
                                  this.__currentIndex--,
                            b === this.__prevIndex
                                ? (this.__prevIndex = -1)
                                : b < this.__prevIndex && this.__prevIndex--,
                            a
                        );
                    },
                    __initOptions: function () {
                    ...
                    __render: function () {
                        return (
                            this.callBase(),
                            a(this.__element).addClass(
                                b.classPrefix + 'buttonset'
                            ),
                            this.__initButtons(),
                            this
                        );
                    ...
                    __pressButton: function (b) {
                        (this.__prevIndex = this.__currentIndex),
                            (this.__currentIndex = this.indexOf(b)),
                            this.__currentIndex !== this.__prevIndex &&
                                (b.press(),
                                a.each(this.__widgets, function (a, c) {
                                    c !== b && c.bounce();
                                }),
                                this.trigger('change', {
            ...
            value: function () {
                ...
                return _p.r(13).createClass('Button', {
                    ...
                    __render: function () {
                        switch (
                            (this.callBase(),
                            (this.__iconWidget = new d(this.__options.icon)),
                            (this.__labelWidget = new e(this.__options.label)),
                            this.__options.layout)
                        ) {
                            case 'left':
                            case 'top':
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__labelWidget = null),
                            'object' != typeof this.__options.label &&
                                (this.__options.label = {
                                    text: this.__options.label
                                }),
                            'object' != typeof this.__options.icon &&
                                (this.__options.icon = {
            ...
            value: function () {
                ...
                return a.createClass('ColorPicker', {
                    ...
                    attachTo: function (a) {
                        var b = this;
                        a.on('click', function () {
                            b.appendTo(a.getElement().ownerDocument.body),
                                b.positionTo(a),
                                b.show();
                        });
                    },
                    ...
                    __render: function () {
                        this.callBase(),
                            e(this.__element).addClass(
                                b.classPrefix + 'colorpicker'
                            );
                        var f = a.Tpl.compile(d, this.__options);
                        this.__contentElement.appendChild(e(f)[0]),
                            (this.__previewElement = e(
                                this.__contentElement
                            ).find(
                                '.' + b.classPrefix + 'colorpicker-preview'
                            )),
                            (this.__clearElement = e(
                                this.__contentElement
                            ).find('.' + b.classPrefix + 'colorpicker-clear')),
                            (this.__maskWidget = new c(this.__options.mask));
                    },
                    __initEvent: function () {
                        var a = this;
                        this.callBase(),
                            this.on('click', function (c) {
                                var d,
                                    f = e(c.target);
                                f.hasClass(b.classPrefix + 'colorpicker-item')
                                    ? ((d = f.attr('data-color')),
                                      a.trigger('selectcolor', d),
                                      a.hide())
                                    : f.hasClass(
                                          b.classPrefix + 'colorpicker-clear'
                                      ) &&
                                      (a.trigger('selectcolor', ''), a.hide());
                            }),
                            this.on('mouseover', function (c) {
                                var d,
                                    f = e(c.target);
                                f.hasClass(
                                    b.classPrefix + 'colorpicker-item'
                                ) &&
                                    ((d = f.attr('data-color')),
                                    e(a.__element)
                                        .find(
        ...
        (_p[39] = {
            value: function () {
                ...
                return a.createClass('Container', {
                    ...
                    disable: function () {
                        this.callBase(),
                            e.each(this.__widgets, function (a, b) {
                                b.disable();
                            });
                    },
                    enable: function () {
                    ...
                    appendWidget: function (a) {
                        return this.__valid(a)
                            ? (this.__options.disabled && a.disable(),
                              this.__widgets.push(a),
                              a.appendTo(this.__contentElement),
                              this.__options.column &&
                                  (this.__contentElement.appendChild(
                                      e('<span class="fui-column"></span>')[0]
                                  ),
                                  e(a.getElement()).addClass(
                                      b.classPrefix + 'panel-column-widget'
                                  )),
                              a)
                            : null;
                    },
                    insertWidget: function (a, c) {
                        var d = null;
                        return 0 === this.__widgets.length
                            ? this.appendWidget(c)
                            : this.__valid(c)
                            ? (this.__options.disabled && c.disable(),
                              (d = this.__widgets[a]),
                              this.__widgets.splice(a, 0, c),
                    ...
                    removeWidget: function (a) {
                        return (
                            'number' == typeof a
                                ? (a = this.__widgets.splice(a, 1))
                                : this.__widgets.splice(this.indexOf(a), 1),
                            this.__contentElement.removeChild(a.getElement()),
                            e(a.getElement()).removeClass(
                                b.classPrefix + 'panel-column-widget'
                            ),
                            a
                        );
                    ...
                    __render: function () {
                        return (
                            ...
                            e(this.__element).addClass(
                                b.classPrefix + 'container'
                            ),
                            this.__options.column &&
                                e(this.__element).addClass(
                                    b.classPrefix + 'container-column'
                                ),
                            this
                        );
                    },
                ...
                return a.createClass('Dialog', {
                    ...
                    constructor: function (a) {
                        var c = {
                            ...
                            buttons: [
                                ...
                                {
                                    className:
                                        b.classPrefix + 'xdialog-cancel-btn',
                                    action: 'cancel',
                                    label: '\u53d6\u6d88'
                                }
                            ]
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__maskWidget = null),
                            (this.__buttons = []),
                            this.__target instanceof c &&
                                (this.__target = this.__target.getElement());
                    },
                    __render: function () {
                        this.callBase(),
                            (this.__innerTpl = a.Tpl.compile(
                                e,
                                this.__options
                            )),
                            this.__contentElement.appendChild(
                            ...
                            h(this.__element).addClass(
                                b.classPrefix + 'dialog'
                            ),
                            (this.__headElement = h(
                                '.fui-dialog-head',
                                this.__contentElement
                            )[0]),
                            (this.__bodyElement = h(
                                '.fui-dialog-body',
                                this.__contentElement
                            )[0]),
                            (this.__footElement = h(
                                '.fui-dialog-foot',
                                this.__contentElement
                            )[0]),
                            (this.__maskWidget = new d(this.__options.mask)),
                            (this.__contentElement = this.__bodyElement),
                            this.__options.draggable && this.__initDraggable(),
                            this.__options.closeButton &&
                    ...
                    __initEvent: function () {
                        var a = this;
                        this.callBase(),
                            h([this.__footElement, this.__headElement]).on(
                                'btnclick',
                                function (b, c) {
                    ...
                    __initCloseButton: function () {
                        var a = new f({
                            ...
                            action: 'cancel',
                            icon: { className: 'fui-close-button-icon' }
                        });
                    ...
                    __hint: function () {
                        if (!this.__hinting) {
                            ...
                            var a = h(this.__element),
                                c = this,
                                d = [
                                    b.classPrefix + 'mask-hint',
                                    b.classPrefix + 'mask-animate'
                                ];
                            a.addClass(d.join(' ')),
                ...
                return _p.r(13).createClass('DropPanel', {
                    ...
                    __render: function () {
                        return this.__rendered
                            ? this
                            : (this.__initOptions(),
                              (this.__buttonWidget = new d(
                                  this.__options.button
                              )),
                              (this.__panelWidget = new e(
                                  this.__options.content
                              )),
                              (this.__popupWidget = new f()),
                              (this.__maskWidget = new g(this.__options.mask)),
                              this.callBase(),
                              this.__popupWidget.positionTo(this.__element),
                              a(this.__popupWidget.getElement()).addClass(
                                  b.classPrefix + 'drop-panel-popup'
                              ),
                              ($content = a(
                                  '<div class="' +
                                      b.classPrefix +
                              ...
                              void this.__initDropPanelEvent());
                    },
                    __initOptions: function () {
                    ...
                    __initDropPanelEvent: function () {
                        ...
                        this.__buttonWidget.on('click', function () {
                            a.__popupState ||
                                (a.__appendPopup(), (a.__popupState = !0)),
                                a.trigger('buttonclick'),
                                a.open();
                        }),
        ...
        (_p[42] = {
            value: function () {
                ...
                return _p.r(13).createClass('Icon', {
                    ...
                    setImage: function (a) {
                        return this.__options.img === a
                            ? this
                            : (this.__image && (this.__image.src = a),
                              void this.trigger('iconchange', {
                    ...
                    __render: function () {
                        (this.__options.__width = this.__options.width),
                            ...
                            this.callBase(),
                            this.__options.img &&
                                ((this.__image = a('img', this.__element)[0]),
                                null !== this.__options.__width &&
                                    (this.__image.width =
                                        this.__options.__width),
                                null !== this.__options.__height &&
                                    (this.__image.height =
                                        this.__options.__height));
                    }
                });
            }
        }),
                ...
                return _p.r(13).createClass('InputButton', {
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__inputWidget = null),
                            (this.__buttonWidget = null),
                            'object' != typeof this.__options.input &&
                                (this.__options.input = {
                                    placeholder: this.__options.input
                                }),
                            (this.__options.input = a.extend(
                                {},
                                this.__options.input,
                    ...
                    __render: function () {
                        ...
                        switch (
                            ...
                            (this.__inputWidget = new e(this.__options.input)),
                            this.__options.layout)
                        ) {
                            case 'left':
                            case 'top':
                            ...
                            default:
                                this.__inputWidget.appendTo(this.__element),
                                    this.__buttonWidget.appendTo(
                                        this.__element
                                    );
                        }
                        a(this.__element).addClass(
                            b.classPrefix + 'layout-' + this.__options.layout
                        ),
                            this.__buttonWidget.on('click', function () {
        ...
        (_p[44] = {
            value: function () {
                ...
                return _p.r(13).createClass('InputMenu', {
                    ...
                    __render: function () {
                        (this.__inputWidget = new c(this.__options.input)),
                            (this.__menuWidget = new d(this.__options.menu)),
                            (this.__maskWidget = new e(this.__options.mask)),
                            this.callBase(),
                            this.__inputWidget.appendTo(this.__element),
                    ...
                    __initInputValue: function () {
                        var a = this.__menuWidget.getItem(
                            this.__options.selected
                        );
                        a && this.__inputWidget.setValue(a.getValue());
                    },
                    __initEvent: function () {
                        var a = this;
                        this.callBase(),
            ...
            value: function () {
                ...
                return _p.r(13).createClass('Input', {
                    ...
                    selectRange: function (a, b) {
                        a || (a = 0),
                            b || (b = 1e9),
                            this.__element.setSelectionRange(a, b);
                    },
                    focus: function () {
                    ...
                    __render: function () {
                        this.callBase(),
                            ...
                            this.addClass(a.classPrefix + 'selectable');
                    },
                    __initEvent: function () {
                        this.callBase(),
        ...
        (_p[46] = {
            value: function () {
                ...
                return a.createClass('Item', {
                    ...
                    __render: function () {
                        this.callBase(),
                            (this.__iconWidget = new c(this.__options.icon)),
                            (this.__labelWidget = new d(this.__options.label)),
                    ...
                    __update: function (a) {
                        return (
                            (a = !!a),
                            f(this.__element)[a ? 'addClass' : 'removeClass'](
                                e.classPrefix + 'item-selected'
                            ),
                            (this.__selectState = a),
                            this.trigger(a ? 'itemselect' : 'itemunselect'),
                            this
                        );
                    },
                    __initEvent: function () {
            ...
            value: function () {
                ...
                return a.createClass('LabelPanel', {
                    ...
                    __render: function () {
                        var a = null;
                        return (
                            (this.__labelWidget = new c(this.__options.label)),
                            this.callBase(),
                            d(this.__element).addClass(
                                b.classPrefix + 'label-panel'
                            ),
                            d(this.__element).addClass(
                                b.classPrefix +
                                    'layout-' +
                            ...
                            this.__contentElement.appendChild(a[0]),
                            (this.__contentElement = a[0]),
                            this
                        );
                    },
                    __initOptions: function () {
            ...
            value: function () {
                ...
                return a.createClass('Label', {
                    ...
                    setText: function (a) {
                        ...
                        return (
                            (this.__options.text = a),
                            c(this.__element).text(a),
                ...
                return b.createClass('Mask', {
                    ...
                    show: function () {
                        ...
                        this.__target ||
                            ...
                            (a = this.__target.ownerDocument.documentElement),
                            e.contains(a, this.__element) ||
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__tpl = c),
                            (this.__cacheId = g.length),
                            (this.__hideState = !0),
                            g.push(this),
                            (this.__target = this.__options.target),
                            this.__target instanceof d &&
                                (this.__target = this.__target.getElement());
                    },
                    __render: function () {
                        this.callBase(),
                    ...
                    __resize: function () {
                        var a = null;
                        this.__targetIsBody()
                            ? ((a = e(b.getView(this.__target))),
                              (a = { width: a.width(), height: a.height() }))
                            : (a = b.getRect(this.__target)),
                            (this.__element.style.width = a.width + 'px'),
                            (this.__element.style.height = a.height + 'px');
                    },
                    __position: function () {
                        var a = null,
                            c = null;
                        this.__targetIsBody()
                            ? (a = { top: 0, left: 0 })
                            : ((c = b.getRect(this.__target)),
                              (a = { top: c.top, left: c.left })),
                            e(this.__element)
                                .css('top', a.top + 'px')
                                .css('left', a.left + 'px');
                    },
            ...
            value: function () {
                ...
                return a.createClass('Menu', {
                    ...
                    insertWidget: function (a, b) {
                        ...
                        return null === c
                            ? c
                            : (a <= this.__currentSelect &&
                                  this.__currentSelect++,
                              a <= this.__prevSelect && this.__prevSelect++,
                              c);
                    },
                    removeWidget: function (a) {
                        var b = a;
                        return (
                            'number' != typeof b && (b = this.indexOf(a)),
                            (a = this.callBase(a)),
                            b === this.__currentSelect
                                ? (this.__currentSelect = -1)
                                : b < this.__currentSelect &&
                                  this.__currentSelect--,
                            b === this.__prevSelect
                                ? (this.__prevSelect = -1)
                                : b < this.__prevSelect && this.__prevSelect--,
                            a
                        );
                    },
                    __initOptions: function () {
                    ...
                    __render: function () {
                        ...
                        this.callBase(),
                            d(this.__element).addClass(c.classPrefix + 'menu'),
                            d.each(this.__options.items, function (c, d) {
                                'object' != typeof d && (d = { label: d }),
                                    (d.selected = c === f),
                                    (d.textAlign = e),
                                    a.appendItem(new b(d));
                            });
                    },
                    __initEvent: function () {
                        this.callBase(),
                            this.on('itemclick', function (a) {
                                this.__selectItem(a.widget);
                            });
                    },
                    __selectItem: function (a) {
                        if (
                            ...
                            (this.__currentSelect = this.indexOf(a)),
                            a.select(),
                            this.trigger('select', {
                            ...
                            var b = this.__widgets[this.__prevSelect] || null;
                            this.trigger('change', {
                                from: {
            ...
            value: function () {
                ...
                return a.createClass('Panel', {
                    ...
                    __render: function () {
                        var a = null;
                        this.callBase(),
                            (a = c('<div class="fui-panel-content"></div>')),
                            this.__contentElement.appendChild(a[0]),
                            (this.__contentElement = a[0]);
                    },
                    __initOptions: function () {
                ...
                return a.createClass('PPanel', {
                    ...
                    show: function () {
                        ...
                        return this.__target
                            ? (this.__options.bound ||
                                  (this.__options.bound =
                                      this.__target.ownerDocument.body),
                              (b = this.__target.ownerDocument.documentElement),
                              e.contains(b, this.__element) ||
                                  this.__target.ownerDocument.body.appendChild(
                                      this.__element
                                  ),
                              e.contains(b, this.__target) &&
                                  (this.callBase(a.getMarker()),
                                  this.__position(),
                                  this.__resize()),
                              this)
                            : this.callBase();
                    ...
                    __initOptions: function () {
                        this.callBase(),
                            ...
                            (this.__target = this.__options.target),
                            (this.__layout = this.__options.layout),
                            (this.__height_resized = !1);
                    },
                    __render: function () {
                        this.callBase(),
                            e(this.__element).addClass(
                                b.classPrefix + 'ppanel'
                            );
                    },
                    __position: function () {
                        var a = null;
                        e(this.__element).addClass(
                            b.classPrefix + 'ppanel-position'
                        ),
                            (a = this.__getLocation()),
                            e(this.__element)
                                .css('top', a.top + 'px')
                                .css('left', a.left + 'px');
                    },
                    ...
                    __resizeWidth: function (a) {
                        if (this.__target) {
                            var b = e(this.__element),
                                ...
                                d = a.width - c.bl - c.br - c.pl - c.pr;
                            this.__element.style.minWidth = d + 'px';
                        }
                    },
                    __resizeHeight: function () {
                        var b = null,
                            c = null,
                            d = 0;
                        (c = a.getRect(this.__element)),
                            (c.height = this.__element.scrollHeight),
                            (c.bottom = c.top + c.height),
                            (b = this.__getBoundRect()),
                            (d = c.bottom - b.bottom),
                            d > 0
                                ? ((this.__height_resized = !0),
                                  e(this.__element).css(
                                      'height',
                                      c.height - d - this.__options.diff + 'px'
                                  ))
                                : this.__height_resized &&
                    ...
                    __getInnerLayout: function (b) {
                        ...
                        switch (this.__layout) {
                            ...
                            case d.RIGHT_TOP:
                                (c.top = b.top),
                                    (c.left = b.left + b.width - e.width);
                                break;
                            case d.LEFT_BOTTOM:
                                (c.top = b.top + b.height - e.height),
                                    (c.left = b.left);
                                break;
                            case d.RIGHT_BOTTOM:
                                (c.top = b.top + b.height - e.height),
                    ...
                    __getBoundRect: function () {
                        var b = -1,
                            ...
                            d = null;
                        return 'body' ===
                            this.__options.bound.tagName.toLowerCase()
                            ? ((d = a.getView(this.__options.bound)),
                              (b = e(d).width()),
                              (c = e(d).height()),
                              {
                                  top: 0,
                    ...
                    __correctionLocation: function (b) {
                        ...
                        switch (this.__layout) {
                            case d.LEFT_TOP:
                            case d.LEFT_BOTTOM:
                                b.left + c.width > f.right &&
                                    (b.left = b.left + e.width - c.width);
                                break;
                            case d.RIGHT_TOP:
                            case d.RIGHT_BOTTOM:
        ...
        (_p[54] = {
            value: function () {
                ...
                return _p.r(13).createClass('SpinButton', {
                    base: _p.r(57),
                    constructor: function (b) {
                        var c = { suffix: null, selected: -1, items: [] };
                        (b = a.extend({}, c, b)), this.callBase(b);
                    },
                    getValue: function () {
                        return (
                            this.__options.items[this.__currentSelected] || null
                        );
                    },
                    setValue: function () {},
                    select: function (a) {
                    ...
                    selectByValue: function (b) {
                        (b += ''),
                            this.__update(a.inArray(b, this.__options.items));
                    },
                    __render: function () {
                        this.callBase(),
                            (this.__buttons = [
                            ...
                            (this.__inputWidget = new e()),
                            (this.__panelWidget = new f({ column: !0 })),
                            this.__inputWidget.appendTo(this.__element),
                    ...
                    __update: function (a, b) {
                        var c = -1,
                            d = null;
                        0 > a ||
                            a >= this.__options.items.length ||
                            ((c = this.__currentSelected),
                            (this.__currentSelected = a),
                            (d = this.__options.items[this.__currentSelected]),
                            this.__inputWidget.setValue(
                                d + ' ' + (this.__options.suffix || '')
                            ),
                            b !== !1 &&
                                this.trigger('change', {
        ...
        (_p[55] = {
            value: function () {
                ...
                return _p.r(13).createClass('Tabs', {
                    base: _p.r(57),
                    constructor: function (b) {
                        var c = { selected: 0, buttons: [], panels: null };
                        (b = a.extend({}, c, b)), this.callBase(b);
                    },
                    getButtons: function () {
                        return this.__btns;
                    ...
                    select: function (a) {
                        var b = null;
                        return this.__selectItem(a)
                            ? ((b = this.__getInfo(a)),
                              this.trigger('tabsselect', b),
                    ...
                    __render: function () {
                        var b = this,
                            ...
                            f = null;
                        this.callBase(),
                            (c = a('.fui-tabs-button-wrap', this.__element)[0]),
                            (f = a('.fui-tabs-panel-wrap', this.__element)[0]),
                            a.each(this.__options.buttons, function (a, e) {
                                var f = null;
                                'object' != typeof e && (e = { label: e }),
                                    (f = new d(e)),
                                    f.on('click', function () {
                                        b.select(b.getIndexByButton(this));
                                    }),
                                    b.__btns.push(f),
                                    f.appendTo(c);
                            }),
                            a.each(this.__options.panels, function (a, c) {
                                var d = null;
                                (c = c || { hide: !0 }),
                                    (c.hide = !0),
                                    (d = new e(c)),
        ...
        (_p[56] = {
            value: function () {
                ...
                return _p.r(13).createClass('ToggleButton', {
                    ...
                    press: function () {
                        a(this.__element).addClass(
                            b.classPrefix + 'button-pressed'
                        ),
                            this.__updateState(!0);
                    },
                    bounce: function () {
                        a(this.__element).removeClass(
                            b.classPrefix + 'button-pressed'
                        ),
                            this.__updateState(!1);
                    },
                    toggle: function () {
                    ...
                    h = _p.r(13).createClass('Widget', {
                        constructor: function (a) {
                            ...
                            (this.__widgetType = 'widget'),
                                ...
                                (this.__options = {}),
                                (this.__element = null),
                                (this.__allow_focus = !1),
                                (this.widgetName = 'Widget'),
                                this.__extendOptions(b, a),
                                this.__initOptions(),
                                this.__render(),
                                this.__initEvent(),
                        ...
                        addClass: function (a) {
                            f(this.__element).addClass(a);
                        },
                        removeClass: function (a) {
                            f(this.__element).removeClass(a);
                        },
                        isDisabled: function () {
                            return this.__options.disabled;
                        },
                        enable: function () {
                            return (
                                (this.__options.disabled = !1),
                                f(this.__element).removeClass(
                                    d.classPrefix + 'disabled'
                                ),
                                this
                            );
                        },
                        disable: function () {
                            return (
                                (this.__options.disabled = !0),
                                f(this.__element).addClass(
                                    d.classPrefix + 'disabled'
                                ),
                                this
                            );
                        ...
                        off: function (a, b) {
                            return (
                                f(this.__element).off(b && b.__fui_listener),
                                this
                            );
                        },
                        on: function (a, b) {
                            return (
                                this.__options.preventDefault ||
                                    this.__on(a, b),
                                this
                            );
                        },
                        ...
                        __render: function () {
                            ...
                            return (
                                (this.id = this.__id()),
                                e.__registerInstance(this),
                                (this.__compiledTpl = g.Tpl.compile(
                                    this.__tpl,
                                    this.__options
                                )),
                                (this.__element = f(this.__compiledTpl)[0]),
                                this.__element.setAttribute('id', this.id),
                                (a = f(this.__element)),
                                this.__options.disabled &&
                                    a.addClass(d.classPrefix + 'disabled'),
                                a.addClass(d.classPrefix + 'widget'),
                                (b = this.__options.className),
                                b.length > 0 &&
                                    a.addClass(f.isArray(b) ? b.join(' ') : b),
                                this.__initBasicEnv(),
                                this.__options.hide && this.__hide(),
                                this
                            );
                        },
                        __appendChild: function (a) {
                        ...
                        __on: function (a, b) {
                            var c = this;
                            return (
                                (b.__fui_listener = function (a, d) {
                                    for (
                                        var e = [], f = 0, g = arguments.length;
                                        g > f;
                                        f++
                                    )
                                        1 !== f && e.push(arguments[f]);
                                    return (
                                        (a.widget = d),
                                        c.isDisabled() ? void 0 : b.apply(c, e)
                                    );
                                }),
                        ...
                        __triggerHandler: function (a) {
                            return f(this.__element).triggerHandler(
                                a,
                                [this].concat([].slice.call(arguments, 1))
                            );
                        },
                        __fire: function (a, b) {
                            var c = { cancel: !1 };
                            return 0 === a.indexOf('before') ||
                                0 === a.indexOf('after')
                                ? this
                                : (this.__trigger('before' + a, c),
                                  c.cancel === !0
                                      ? this
                                      : ((c = b.call(this, a)),
                                        this.__trigger(a),
                                        this.__trigger('after' + a, c),
                                        this));
                        },
                        __extendOptions: function () {
                            for (
                                var a = [{}, this.__options].concat(
                        ...
                        __initBasicEnv: function () {
                            this.__options.text &&
                                this.__allowShowTitle() &&
                                this.__element.setAttribute(
                                    'title',
                                    this.__options.text
                                ),
                                this.__options.width &&
    ...
    var moduleMapping = { 'fui.export': 58 };
    use('fui.export');
})();
