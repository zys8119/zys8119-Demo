...
(function () {
    ...
    _p[5] = {
        value: function (require, exports) {
            ...
            Class.prototype.base = function (name) {
                ...
                var method =
                    caller.__KityMethodClass.__KityBaseClass.prototype[name];
                return method.apply(
                    this,
                ...
                for (i = 0; i < length; i++) {
                    ...
                    for (method in proto) {
                        ...
                        if (method === 'constructor') {
                            // constructor 特殊处理
                            NewClass.__KityMixins.constructor.push(
                                proto[method]
                            );
                        } else {
                            NewClass.prototype[method] = NewClass.__KityMixins[
                                method
                            ] = proto[method];
                        }
                    }
            ...
            exports.createClass = function (classname, defines) {
                ...
                NewClass.__KityClassName = constructor.__KityClassName =
                    classname;
                NewClass.__KityBaseClass = constructor.__KityBaseClass =
                    BaseClass;
                NewClass.__KityMethodName = constructor.__KityMethodName =
                    'constructor';
                NewClass.__KityMethodClass = constructor.__KityMethodClass =
                    NewClass;
                // 下面这些不需要拷贝到原型链上
        ...
        value: function (require, exports) {
            ...
            $.extend(Draggable.prototype, {
                ...
                __initOptions: function () {
                    ...
                    if (!this.__rangeNode) {
                        this.__rangeNode =
                            this.__options.target.ownerDocument.body;
                    }
            ...
            return _p.r(13).createClass('TPicker', {
                ...
                __createBackplane: function () {
                    ...
                    for (var i = 0, len = this.__options.row; i < len; i++) {
                        tmp = [];
                        for (
                            var j = 0, jlen = this.__options.col;
                            j < jlen;
                            j++
                        ) {
                            tmp.push(
                                '<td data-index="' + i + ',' + j + '"></td>'
                            );
                        }
                        tpl.push('<tr>' + tmp.join('') + '</tr>');
                    }
                    tpl = $(
                        '<table><tbody>' + tpl.join('') + '</tbody></table>'
                    );
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('TablePicker', {
                ...
                __initEvent: function () {
                    ...
                    this.__pickerWidget
                        .on('pickerhover', function (e, info) {
                            var row = info.row + 1,
                                col = info.col + 1;
                            _self.__labelWidget.setText(
                                row + 'x' + col + ' 表格'
                            );
                        })
    ...
    _p[20] = {
        value: function () {
            return (
                '<div unselectable="on" class="fui-colorpicker-container">\n' +
    ...
    _p[21] = {
        value: function () {
            return (
                '<div unselectable="on" class="fui-dialog-wrap">\n' +
    ...
    _p[23] = {
        value: function () {
            return (
                '<div unselectable="on" class="fui-icon" >\n' +
                'if ( this.img ) {\n' +
    ...
    _p[33] = {
        value: function () {
            return (
                '<div unselectable="on" class="fui-tabs">\n' +
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('ButtonMenu', {
                ...
                __render: function () {
                    ...
                    this.__menuWidget.appendTo(
                        this.__element.ownerDocument.body
                    );
                },
                __initOptions: function () {
                    this.callBase();
                ...
                __initButtons: function () {
                    ...
                    if (
                        this.__options.layout === LAYOUT.TOP ||
                        this.__options.layout === LAYOUT.LEFT
                    ) {
                    ...
                    this.addClass(
                        CONF.classPrefix + 'layout-' + this.__options.layout
                    );
                    buttons[buttons.length - 1].addClass(
                        CONF.classPrefix + 'open-btn'
                    );
                    this.__buttonWidgets = buttons;
                },
                __initEvent: function () {
                    var lastBtn =
                            this.__buttonWidgets[
                                this.__buttonWidgets.length - 1
                            ],
                        _self = this;
                    this.callBase();
                    ...
                    this.on('btnclick', function (e) {
                        e.stopPropagation();
                        var btnIndex = $.inArray(
                            e.widget,
                            this.__buttonWidgets
                        );
                        if (
                            btnIndex > -1 &&
                            btnIndex < this.__buttonWidgets.length - 1
                        ) {
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('InputMenu', {
                ...
                __appendMenu: function () {
                    this.__menuWidget.appendTo(
                        this.__inputWidget.getElement().ownerDocument.body
                    );
                }
            });
        }
            ...
            return _p.r(13).createClass('Buttonset', {
                ...
                __initButtons: function () {
                    var _self = this,
                        buttonWidget = null;
                    $.each(
                        this.__options.buttons,
                        function (index, buttonOption) {
                            buttonWidget = new ToggleButton(
                                $.extend({}, buttonOption, {
            ...
            return _p.r(13).createClass('Button', {
                ...
                __render: function () {
                    ...
                    switch (this.__options.layout) {
                        case 'left':
                        case 'top':
                            this.__element.appendChild(
                                this.__labelWidget.getElement()
                            );
                            this.__element.appendChild(
                                this.__iconWidget.getElement()
                            );
                            break;
                    ...
                    $(this.__element).addClass(
                        CONF.classPrefix +
                            'button-layout-' +
                            this.__options.layout
                    );
                },
                __initOptions: function () {
                    this.callBase();
        ...
        value: function (require) {
            ...
            return Utils.createClass('ColorPicker', {
                ...
                __render: function () {
                    this.callBase();
                    $(this.__element).addClass(
                        CONF.classPrefix + 'colorpicker'
                    );
                    var contentHtml = Utils.Tpl.compile(tpl, this.__options);
                    this.__contentElement.appendChild($(contentHtml)[0]);
                    this.__previewElement = $(this.__contentElement).find(
                        '.' + CONF.classPrefix + 'colorpicker-preview'
                    );
                    this.__clearElement = $(this.__contentElement).find(
                        '.' + CONF.classPrefix + 'colorpicker-clear'
                    );
                    this.__maskWidget = new Mask(this.__options.mask);
                },
                // 初始化点击事件
                __initEvent: function () {
                    ...
                    this.on('click', function (e) {
                        ...
                        if (
                            $target.hasClass(
                                CONF.classPrefix + 'colorpicker-item'
                            )
                        ) {
            ...
            return Utils.createClass('Container', {
                ...
                appendWidget: function (widget) {
                    ...
                    if (this.__options.column) {
                        this.__contentElement.appendChild(
                            $('<span class="fui-column"></span>')[0]
                        );
                        $(widget.getElement()).addClass(
                            CONF.classPrefix + 'panel-column-widget'
                        );
                    }
                    return widget;
                },
                insertWidget: function (index, widget) {
                    ...
                    this.__contentElement.insertBefore(
                        widget.getElement(),
                ...
                __render: function () {
                    ...
                    if (this.__options.column) {
                        $(this.__element).addClass(
                            CONF.classPrefix + 'container-column'
                        );
                    }
                    return this;
                },
        ...
        value: function (require) {
            ...
            return Utils.createClass('Dialog', {
                ...
                constructor: function (options) {
                    var defaultOptions = {
                        ...
                        buttons: [
                            ...
                            {
                                className:
                                    CONF.classPrefix + 'xdialog-cancel-btn',
                                action: 'cancel',
                                label: '取消'
                            }
                        ]
                ...
                __initEvent: function () {
                    var _self = this;
                    this.callBase();
                    $([this.__footElement, this.__headElement]).on(
                        'btnclick',
                        function (e, btn) {
                ...
                __hint: function () {
                    ...
                    var $ele = $(this.__element),
                        _self = this,
                        classNmae = [
                            CONF.classPrefix + 'mask-hint',
                            CONF.classPrefix + 'mask-animate'
                        ];
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('DropPanel', {
                ...
                open: function () {
                    ...
                    $popup.css(
                        'top',
                        parseInt($popup.css('top')) -
                            $(this.__element).height() -
                            1
                    );
                },
                close: function () {
                ...
                __render: function () {
                    ...
                    $(this.__popupWidget.getElement()).addClass(
                        CONF.classPrefix + 'drop-panel-popup'
                    );
                    // 初始化content
                    $content = $(
                        '<div class="' +
                            CONF.classPrefix +
                            'drop-panel-content"></div>'
                    ).append(this.__panelWidget.getElement());
                    this.__contentElement = $content[0];
                    // 插入按钮到element
                    $(this.__element)
                        .append($content)
                        .append(this.__buttonWidget.getElement());
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('InputMenu', {
                ...
                __initInputValue: function () {
                    var selectedItem = this.__menuWidget.getItem(
                        this.__options.selected
                    );
                    if (selectedItem) {
    ...
    _p[46] = {
        value: function (require) {
            ...
            return Utils.createClass('Item', {
                ...
                getValue: function () {
                    return (
                        this.__labelWidget.getValue() ||
                        this.__iconWidget.getValue() ||
                        null
                    );
                },
                select: function () {
                ...
                __update: function (state) {
                    state = !!state;
                    $(this.__element)[state ? 'addClass' : 'removeClass'](
                        CONF.classPrefix + 'item-selected'
                    );
                ...
                __initOptions: function () {
                    ...
                    if (!this.__options.label.textAlign) {
                        this.__options.label.textAlign =
                            this.__options.textAlign;
                    }
                    if (typeof this.__options.icon !== 'object') {
                        this.__options.icon = {
                            img: this.__options.icon
        ...
        value: function (require) {
            ...
            return Utils.createClass('LabelPanel', {
                ...
                __render: function () {
                    ...
                    this.callBase();
                    $(this.__element).addClass(
                        CONF.classPrefix + 'label-panel'
                    );
                    $(this.__element).addClass(
                        CONF.classPrefix + 'layout-' + this.__options.layout
                    );
                    $contentElement = $(
                        '<div class="fui-label-panel-content"></div>'
                    );
                    this.__contentElement.appendChild(
                        this.__labelWidget.getElement()
                    );
            ...
            return Utils.createClass('Menu', {
                ...
                __selectItem: function (item) {
                    ...
                    if (this.__prevSelect !== this.__currentSelect) {
                        var fromItem =
                            this.__widgets[this.__prevSelect] || null;
                        this.trigger('change', {
                            from: {
        ...
        value: function (require) {
            ...
            return Utils.createClass('PPanel', {
                ...
                show: function () {
                    ...
                    docNode = this.__target.ownerDocument.documentElement;
                    if (!$.contains(docNode, this.__element)) {
                        this.__target.ownerDocument.body.appendChild(
                            this.__element
                        );
                    }
                ...
                __position: function () {
                    var location = null;
                    $(this.__element).addClass(
                        CONF.classPrefix + 'ppanel-position'
                    );
                ...
                __resizeWidth: function (targetRect) {
                    ...
                    var $ele = $(this.__element),
                        vals = {
                            bl:
                                parseInt($ele.css('border-left-width'), 10) ||
                                0,
                            br:
                                parseInt($ele.css('border-right-width'), 10) ||
                                0,
                ...
                __resizeHeight: function () {
                    ...
                    if (diff > 0) {
                        ...
                        $(this.__element).css(
                            'height',
                            panelRect.height - diff - this.__options.diff + 'px'
                        );
        ...
        value: function (require) {
            ...
            return _p.r(13).createClass('SpinButton', {
                ...
                __update: function (index, isTrigger) {
                    ...
                    this.__inputWidget.setValue(
                        toValue + ' ' + (this.__options.suffix || '')
                    );
                    if (isTrigger !== false) {
                        this.trigger('change', {
            ...
            return _p.r(13).createClass('Tabs', {
                ...
                __initOptions: function () {
                    ...
                    if (this.__options.panels === null) {
                        ...
                        this.__options.panels.length =
                            this.__options.buttons.length;
                    }
                },
    ...
    _p[56] = {
        value: function (require) {
            ...
            return _p.r(13).createClass('ToggleButton', {
                ...
                press: function () {
                    $(this.__element).addClass(
                        CONF.classPrefix + 'button-pressed'
                    );
                ...
                __render: function () {
                    this.callBase();
                    $(this.__element).addClass(
                        CONF.classPrefix + 'toggle-button'
                    );
        ...
        value: function (require) {
            ...
            var Widget = _p.r(13).createClass('Widget', {
                ...
                __render: function () {
                    ...
                    this.__compiledTpl = Utils.Tpl.compile(
                        this.__tpl,
                        this.__options
                    );
                ...
                __trigger: function (type, params) {
                    $(this.__element).trigger(
                        type,
                        [this].concat([].slice.call(arguments, 1))
                    );
                    return this;
                },
                __triggerHandler: function (type, params) {
                    return $(this.__element).triggerHandler(
                        type,
                        [this].concat([].slice.call(arguments, 1))
                    );
                },
                ...
                __fire: function (type, handler) {
                    ...
                    if (
                        type.indexOf('before') === 0 ||
                        type.indexOf('after') === 0
                    ) {
                        return this;
                    }
                ...
                __extendOptions: function () {
                    var args = [{}, this.__options].concat(
                ...
                __initBasicEnv: function () {
                    ...
                    if (this.__options.width) {
                        this.__element.style.width =
                            this.__options.width + 'px';
                    }
                    if (this.__options.height) {
                        this.__element.style.height =
                            this.__options.height + 'px';
                    }
                    if (this.widgetName) {
