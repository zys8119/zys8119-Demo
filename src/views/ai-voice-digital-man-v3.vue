...
<!--      <canvas class="abs-content" ref="convasRef" style="transform: scale(1.5) translateY(-15%)"></canvas>-->
      ...
      <div ref="voiceBtnRef" class="abs-end-bottom w-86px rigth-30px bottom-150px flex-center flex-col bg-#fff5 p-15px b-rd-y-10px cursor-pointer text-50px" @click.stop="dazhaohu">
        <svg-icon name="dazhaohu" not-fill></svg-icon>
        <div class="text-14px">语音交流</div>
      </div>
      <div class="abs-end-bottom w-86px rigth-30px bottom-30px flex-center flex-col bg-#fff5 p-15px b-rd-y-10px cursor-pointer text-50px" @click.stop="dazhaohu">
        <svg-icon name="dazhaohu" not-fill></svg-icon>
