import {IButtonMenu, IModuleConf,IDomEditor,SlateElement, DomEditor} from "@wangeditor/editor"
...
export const useEditorModule = function (options:Partial<UseEditorModuleType> = {}):Partial<IModuleConf>{
    const config = merge({
        exec(){},
    ...
    return {
        ...
        parseElemsHtml:[
            {
                ...
                parseElemHtml(domElem: Element, children: any, editor: IDomEditor): SlateElement {  // TS 语法
        ...
        editorPlugin:function <T extends IDomEditor>(editor: IDomEditor):T {  // TS 语法
